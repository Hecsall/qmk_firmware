...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  /* Keymap Fn 2 Layer
   * ,----------------------------------------------------------------.
   * |~ `|F13|F14|F15|F16|F17|F18|F19|F20|F21|F22|F23|F24|Del    |Ins |
   * |----------------------------------------------------------------|
   * |     |   |   |   |   |   |   |   |   |   |   |   |   |     |    |
   * |----------------------------------------------------------------|
   * |      | C |   |   |   |   |   |   |   |   |   |   |        |    |
  ...
  [2] = LAYOUT_65_ansi(
    ...
    _______, _______,          MI_Cs,   MI_Ds, _______,   MI_Fs,   MI_Gs,   MI_As, _______, MI_Cs_1, MI_Ds_1, _______, _______, _______, _______, \
    _______,    MI_C,           MI_D,    MI_E,    MI_F,    MI_G,    MI_A,    MI_B,  MI_C_1,  MI_D_1,  MI_E_1,  MI_F_1,          _______, _______, \
     MI_SUS, _______,        _______, _______, _______, _______, _______, _______, _______, _______, _______,          _______, KC_PGUP, _______, \
